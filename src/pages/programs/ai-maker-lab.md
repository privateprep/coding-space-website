...
pageBuilder:
  ...
  - type: textAndImageBlock
    ...
    mediaPosition: right
    mdContent: >-
      ## **Create with Cutting-Edge Tools**


      Students explore how AI actually works by *building with it*.\

      They use fun, accessible tools such as:


      * **Teachable Machine** → train image/sound models

      * **Machine Learning for Kids** → build text-based models
